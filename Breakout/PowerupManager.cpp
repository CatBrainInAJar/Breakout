...
void PowerupManager::spawnPowerup()
{
    ...
    case 4:
        ...
        break;
    case 5:
        _powerups.push_back(new PowerupHealth(_window, _paddle, _ball /*,gameManager */ ));
        break;
    case 6:
    ...
    case 7:
        ...
        break;
    case 8:
        _powerups.push_back(new PowerupMultiBall(_window, _paddle, _ball));//
       break;
    case 9:
       break;
    }
